...
function CarrouselExplore() {
  return (
    <>
         <div className="contain-texto py-5  mt-4 ">
                    <h3 className="text-white  font-akshar display-3">Explore More</h3>
          </div>
                    ...
                    <div className="card p-3 bg-cards me-0  " >
                        ...
                        <div className="card-body px-0 pb-0 ">
                            ...
                            <div className="contain-autions pt-2 d-flex justify-content-between align-items-center ">
                                ...
                                <span className="text-white"><i className="bi bi-arrow-up-short text-danger"></i>5.4 ETH</span>
                            </div> 
                            ...
                            <div className="contain-price mt-2  d-flex justify-content-center  bg-negro-claro p-2 rounded ">
                                <strong><a href="#" className="text-white text-decoration-none"><i className="bi bi-handbag"></i> Place a bit</a></strong>
                            </div>
                        </div> 
                    </div>
                    </div>
